...
return [
    ...
    'auth' => [
        ...
        // Enables the Authentication page + Bearer token input in the UI.
        'enabled' => true,
        ...
        // For BEARER auth, this is ignored at runtime, but setting it for clarity.
        'name' => 'Authorization',

        // The value of the parameter to be used by Scribe to authenticate response calls.
        // This will NOT be included in the generated documentation. If empty, Scribe will use a random value.
        // Value Scribe will use in response calls. You can set SCRIBE_AUTH_KEY in .env
        'use_value' => env('SCRIBE_AUTH_KEY'),

        // Placeholder your users will see for the auth parameter in the example requests.
        // Set this to null if you want Scribe to use a random value as placeholder instead.
        // Placeholder shown in examples/UI.
        'placeholder' => '{token}',
